      ...
      <div style="max-width:650px;margin:auto;background:#111827;border:1px solid #1f2937;border-radius:24px;overflow:hidden;">
        ...
        <div style="padding:34px;">
          ...
          <div style="text-align:center;margin-top:30px;">
            <a href="{activation_link}" style="background:#ef0000;color:white;text-decoration:none;padding:16px 28px;border-radius:14px;font-weight:900;">
              Activate License
            </a>
          </div>
        </div>
    ...
    <div style="background:#080A0F;padding:40px;font-family:Arial;color:white;">
      <div style="max-width:650px;margin:auto;background:#111827;border:1px solid #1f2937;border-radius:24px;overflow:hidden;">
        ...
        <div style="padding:34px;">
          ...
          <div style="text-align:center;margin-top:30px;">
            <a href="{FRONTEND_URL}" style="background:#ef0000;color:white;text-decoration:none;padding:16px 28px;border-radius:14px;font-weight:900;">
              Visit SanityRC
            </a>
          </div>
